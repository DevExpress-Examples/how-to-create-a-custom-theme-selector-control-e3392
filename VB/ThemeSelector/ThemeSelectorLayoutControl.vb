...
#Region "Dependency Properties"
        ...
        Shared Sub New()
            ...
            SelectedValueProperty = DependencyProperty.Register("SelectedValue", GetType(Object), ownerType, New PropertyMetadata(Nothing, AddressOf OnSelectedValuePropertyChanged))
            ...
            SelectingProgressProperty = DependencyProperty.Register("SelectingProgress", GetType(Double), ownerType, New PropertyMetadata(0.0, AddressOf OnSelectionChanged))
            ...
            DoSelectStoryboardProperty = StoryboardProperty.Register("DoSelectStoryboard", ownerType, Nothing, AddressOf OnStoryboardChanged)
        End Sub
#End Region
        ...
        Private Shared Sub OnSelectionChanged(ByVal d As DependencyObject, ByVal e As DependencyPropertyChangedEventArgs)
            CType(d, ThemeSelectorLayoutControl).RaiseSelectingProgressChanged(e)
        End Sub

        Private Shared Sub OnStoryboardChanged(ByVal d As DependencyObject, ByVal e As DependencyPropertyChangedEventArgs)
            CType(d, ThemeSelectorLayoutControl).RaiseDoSelectStoryboardChanged(e)

        End Sub

        Private Shared Sub OnSelectedValuePropertyChanged(ByVal d As DependencyObject, ByVal e As DependencyPropertyChangedEventArgs)
            CType(d, ThemeSelectorLayoutControl).RaiseSelectedValueChanged(e)
        End Sub
        ...
        Public Property ValueTemplate() As DataTemplate
            Get
                Return CType(GetValue(ValueTemplateProperty), DataTemplate)
            End Get
        ...
        Public Property TextTemplate() As DataTemplate
            Get
                Return CType(GetValue(TextTemplateProperty), DataTemplate)
            End Get
            Set(ByVal value As DataTemplate)
        ...
        Public Property DoSelectStoryboard() As Storyboard
            Get
                Return CType(GetValue(DoSelectStoryboardProperty), Storyboard)
            End Get
        ...
        Public Property SelectingProgress() As Double
            Get
                Return CDbl(GetValue(SelectingProgressProperty))
            End Get
        ...
        Private Sub OnValuePresenterMouseEnter(ByVal sender As Object, ByVal e As MouseEventArgs)
            Me.textPresenter.Content = (CType(sender, ContentControl)).Content.ToString()
...
#End If
        ...
        Private Sub EndSelect()
            ...
            BackgroundHelper.DoInBackground(Nothing, Function() AnonymousMethod1())
        End Sub
        ...
        Private Sub RaiseSelectingProgressChanged(ByVal e As DependencyPropertyChangedEventArgs)
            Dim selectingProgress As Double = CDbl(e.NewValue)
        ...
        Private Sub RaiseDoSelectStoryboardChanged(ByVal e As DependencyPropertyChangedEventArgs)
            Dim oldValue As Storyboard = CType(e.OldValue, Storyboard)
            Dim newValue As Storyboard = CType(e.NewValue, Storyboard)
