...
#If SL Then
		...
		End Sub
#Else
		Public NotOverridable Overrides Sub BeginInit() Implements ISupportInitialize.BeginInit
			MyBase.BeginInit()
			BeginInitCore()
		End Sub
		Public NotOverridable Overrides Sub EndInit() Implements ISupportInitialize.EndInit
			EndInitCore()
			MyBase.EndInit()
		End Sub
#End If
