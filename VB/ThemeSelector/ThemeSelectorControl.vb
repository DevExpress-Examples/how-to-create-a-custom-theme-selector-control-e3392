...
Namespace ThemeSelector
	Public Class ThemeSelectedEventArgs
		Inherits EventArgs
        Public Sub New(ByVal theme1 As Theme)
            Theme = theme1
        End Sub
	...
	Public Class ThemeSelectorControl
		...
		End Sub
        Public Sub SelectDefaultTheme(ByVal theme1 As Theme)
            defaultTheme = theme1
            RaiseThemeSelected(theme1)
        End Sub
		...
		End Sub
		Protected Overrides Overloads Sub RaiseActualLoaded()
			MyBase.RaiseActualLoaded()
			themeSelectorLayoutControl.SelectValue(defaultTheme, True)
		End Sub
        Private Sub RaiseThemeSelected(ByVal theme1 As Theme)
            RaiseEvent ThemeSelected(Me, New ThemeSelectedEventArgs(theme1))
        End Sub
		Private Sub OnThemeSelectorLayoutControlSelectedValueChanged(ByVal sender As Object, ByVal e As EventArgs)
			RaiseThemeSelected(CType(themeSelectorLayoutControl.SelectedValue, Theme))
		End Sub
		Protected Overrides Overloads Sub OnApplyTemplateOverride()
